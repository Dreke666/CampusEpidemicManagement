    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="#" title="logoTitle">疫情防控管理信息系统</a>
            </div>
    ...
    <div class="pageContainer">
        ...
        <div class="pageSidebar">
            ...
            <div class="list-group">
                ...
                <a class="list-group-item" href="${pageContext.request.contextPath}/StuQueryInfoServlet" target="mainFrame">
                    <span class="fa fa-user-circle-o fa-lg"></span>
                    查询学生个人信息
                </a>

                <a class="list-group-item" href="${pageContext.request.contextPath}/StuQueryPunchByPageServlet?currentPage=1&rows=7" target="mainFrame">
        ...
        <div class="pageContentTitle">
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/view/stu/stumainview.jsp">管理首页</a></li>
                <li><a href="#">目栏</a></li>
            </ol>
        </div>
