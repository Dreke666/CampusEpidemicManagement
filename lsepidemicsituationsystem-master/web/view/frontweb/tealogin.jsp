...
<body>
     <div class="header-panel head">
         <p style="font-size: 50px"><strong>青岛科技大学，疫情防控管理信息系统</strong></p>
     </div>

     <div class="col-md-4 core">
         <h3 align="center" style="font-weight: bold">教师登录</h3>
         <form action="${pageContext.request.contextPath}/TeaLoginServlet" method="post">
             <div class="form-group">
                 <label for="tno" class="control-label">教工号</label>
                 <input type="text" class="form-control" required="required" placeholder="请输入教工号" id="tno" name="tno" >
             </div>
             <div class="form-group">
                 <label for="psw" class="control-label">密码</label>
                 <input type="password" class="form-control" required="required" placeholder="请输入密码" id="psw" name="tpsw" >
             </div>
             <div class="pull-right form-group">
                 <a href="${pageContext.request.contextPath}/view/frontweb/teaforgetpsw.jsp">忘记密码</a>
             </div>
             <br>
