...
<body>
    ...
    <div class="col-md-4 core">
        <h3 align="center" style="font-weight: bold">教师打卡</h3>
        <form action="${pageContext.request.contextPath}/TeaPunchServlet" method="post">
           <%-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" list="list4" class="form-control" name="tstatus" id="inputstatus" placeholder="请选择健康状态">
                <datalist id="list4">
                    <option>正常</option>
                    <option>异常</option>
                </datalist>
